...
protected:
  void VisualizeMarkerPose(IplImage *image, Camera *cam,
                           ...
                           CvScalar color = cvScalar(CV_RGB(255, 0, 0))) const;
  ...
  bool UpdateContentBasic(std::vector<Point<CvPoint2D64f>> &_marker_corners_img,
...
public:
  MarkerIteratorImpl(typename std::vector<T>::const_iterator i)
      : _begin(i), _i(i) {
    _data = this;
  }
