...
TrackerFeatures::TrackerFeatures(int _max_features, int _min_features,
    ...
    : x_res(0), y_res(0), frame_count(0), quality_level(0), min_distance(0),
      min_features(0), max_features(0), status(0), img_eig(0), img_tmp(0),
      gray(0), prev_gray(0), pyramid(0), prev_pyramid(0), mask(0), next_id(0),
      win_size(0), pyr_levels(0), prev_features(0), features(0),
      prev_feature_count(0), feature_count(0), prev_ids(0), ids(0) {
