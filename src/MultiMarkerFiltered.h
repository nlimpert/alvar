...
public:
  /** \brief Constructor.
          \param indices Vector of marker codes that are included into multi
     marker. The first element defines origin.
  */
  ...
  /** \brief Updates the 3D point cloud by averaging the calculated results.
          \param marker_id The id of the marker whose corner positions are
     updated. \param edge_length The edge length of the marker. \param pose
     Current camera pose that is used to estimate the marker position.
  */
