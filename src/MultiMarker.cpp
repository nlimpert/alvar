...
void MultiMarker::PointCloudReset() { pointcloud.clear(); }
    ...
    if (marker_status[i] == 1) {
      ...
      if (image) {
        cvLine(image, cvPoint(int(p[0].x), int(p[0].y)),
               cvPoint(int(p[1].x), int(p[1].y)), cvScalar(CV_RGB(255, 0, 0)));
        cvLine(image, cvPoint(int(p[1].x), int(p[1].y)),
               cvPoint(int(p[2].x), int(p[2].y)), cvScalar(CV_RGB(255, 0, 0)));
        cvLine(image, cvPoint(int(p[2].x), int(p[2].y)),
               cvPoint(int(p[3].x), int(p[3].y)), cvScalar(CV_RGB(255, 0, 0)));
        cvLine(image, cvPoint(int(p[3].x), int(p[3].y)),
               cvPoint(int(p[0].x), int(p[0].y)), cvScalar(CV_RGB(255, 0, 0)));
      }
