...
public:
  ...
  /**
   * \brief Constructor.
   * \param data	Rotation data stored in CvMat. With RotationType::MAT both
   * 3x3 and 4x4 matrices are allowed.
   ...
   * matrix. \param quat	Rotation in quaternion form. \param mat
